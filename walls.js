...
window.WW_APP = {
  ...
  ensureInstallAssets: function() {
    try {
      ...
      } else if (!manifestLink.getAttribute('href') || manifestLink.getAttribute('href').startsWith('blob:')) {
        manifestLink.href = '/manifest.webmanifest';
      }
...
8. ADMIN FEATURES (Admin only):
  ...
  createDesktopListingCard: function(listing) {
    ...
    categoryBadge.style.cssText = 'position: absolute; top: 8px; left: 8px; background: rgba(46,125,50,0.95); color: white; padding: 4px 10px; border-radius: 6px; font-size: 11px; font-weight: 600; text-transform: uppercase; z-index: 2; backdrop-filter: blur(4px);';
  ...
  createMobileListingCard: function(listing) {
    ...
    catBadge.style.cssText = 'position: absolute; top: 6px; left: 6px; background: rgba(46,125,50,0.95); color: white; padding: 3px 6px; border-radius: 4px; font-size: 9px; font-weight: 600; text-transform: uppercase; z-index: 2;';
